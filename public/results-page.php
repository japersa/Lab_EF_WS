                        ...
                        <div class="col-xs-12" ng-app="EduferApp">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body" ng-hide="step != 1">
                                            <form ng-submit="onSendPin()">
                                                <legend>
                                                    Debe especificar el mismo correo que registró en el momento que se creó como paciente del laboratorio.
                                                </legend>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <span ng-bind="sendPinButton.text">Enviar nueva contraseña</span>
                                                    </button>
                                                    </span>
                                                </div>
                                                <!-- /input-group -->
                                        ...
                                        <div ng-hide="step != 2">
                                            <div class="modal-body">
                                                <div class="alert alert-success recovery-success" role="alert">
                                                    <strong>Listo!</strong> <br> Hemos enviado una nueva contraseña a tu correo electronico. <br>
                                                </div>
                                            </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form ng-submit="onChangePass()" ng-hide="step != 1">
                                            <div class="modal-body">
                                                <legend>
                                                    Para cambiar su contraseña, debe proporcionar tanto su contraseña actual como la que desea establecer.
                                                </legend>
                                                ...
                                                <div ng-hide="changeForm.newPassword == changeForm.newPasswordConfirm" class="alert alert-danger" role="alert">
                                                    <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
                                                    <span class="sr-only">Error:</span> Las contraseñas no coinciden
                                                </div>
                                                <div class="form-group">
                                                    <label>Contraseña actual</label>
                                                    <input type="password" class="form-control" placeholder="Contraseña actual" ng-model="changeForm.currentPassword" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Contraseña nueva</label>
                                                    <input type="password" class="form-control" placeholder="Contraseña nueva" ng-model="changeForm.newPassword" minlength="5" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Confirme su contraseña nueva</label>
                                                    <input type="password" class="form-control" placeholder="Confirme su contraseña nueva" ng-model="changeForm.newPasswordConfirm" minlength="5" required>
                                                </div>
                                        ...
                                        <div ng-hide="step != 2">
                                            <div class="modal-body">
                                                <div class="alert alert-success recovery-success" role="alert">
                                                    <strong>Listo!</strong> <br> Su contraseña se ha modificado exitosamente. <br>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                            ...
                            <div id="signin-container" class="container" ng-controller="Login" ng-hide="logedIn">
                                <form class="form-signin" ng-submit="onLogin()">
                                    ...
                                    <input type="password" id="inputPassword" class="form-control" placeholder="Contraseña" required ng-model=form.password>
                                    ...
                                    <button class="btn btn-lg btn-block btn-link" type="button" data-toggle="modal" data-target="#resetPassModal">Recuperar contraseña</button>
                                </form>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        ...
                                        <a class="btn btn-default btn-block" role="button" data-toggle="modal" data-target="#changePassModal">
                                            <span class="glyphicon glyphicon-lock"></span> Cambiar mi contraseña
                                        </a>
                                        <h4>Pacientes</h4>
                                        <p>En su cuenta están relacionados los siguientes pacientes</p>
                                    ...
                                    <div class="col-sm-9" ng-hide="!currentPat">
                                        ...
                                        <p class="bg-info" style="padding: 12px;">
                                            Por este medio solo podrá consultar sus resultados cuando no hayan quedado muestras pendiente por tomar y estén sus exámenes totalmente procesados. <br/> Si necesita resultados parciales solicítelos.
                                        </p>
									...
									.controller("Login", function($scope, $rootScope, $http) {
										...
										$scope.onLogin = function() {
											...
											$http.post(apibase + "account/login", $scope.form).then(
												...
												function(error) {
													$scope.init();
													var generic_error = "Es posible que el sistema no esté disponible en el momento.";
													if (error.status < 0)
														$scope.error = "No se ha podido establecer comunicación con el servidor. " + generic_error;
													else {
